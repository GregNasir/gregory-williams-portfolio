...
const dataportfolio = 
    ...
    [{
        img: BaseballO,
        description: "This baseball webpage provides users the opportunity to check current stats and odds for the ongoing MLB season.",
        description2: "JavaScript/sequelize/jQuery/HTML/CSS",
        link: "https://jako0320.github.io/baseball_statsandodds/",
        link2: "https://github.com/GregNasir/baseball_statsandodds",
    },
    {
        img: ProdPal,
        description: "Productivity-Pal was conceptualized and created by a team four developers. It is a todo app devloped with the CRUD method.",
        description2: "JavaScript/node/MySql/HTML/CSS",
    ...
    {
        img: WorkDay,
        description: "With a desire to be able to add and save planned events for the day, this work day scheduler was created.",
        description2: "JavaScript/sequelize/HTML/CSS",
